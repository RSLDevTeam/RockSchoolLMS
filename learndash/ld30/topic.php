			...
			<div class="entry-content">
				...
				<div class="<?php echo esc_attr( learndash_the_wrapper_class() ); ?>">
					...
					if ( $soundslice_id ):
						...
						echo '<div class="soundslice-container"><iframe id="ssembed" src="https://www.soundslice.com/slices/' . $soundslice_id  . '/embed/?api=1&enable_print=0&branding=2" width="100%" height="100%" frameBorder="0" allowfullscreen ></iframe></div>';
						?>					
