...
<div class="ld-content-with-sidebar">
		...
		<div class="entry-content">
			...
			<div class="<?php echo esc_attr( learndash_the_wrapper_class() ); ?>">
				...
				if (get_field('track_id')):
					echo '<div class="soundslice-container"><iframe src="https://www.soundslice.com/slices/' . get_field('track_id')  . '/embed/" width="100%" height="100%" frameBorder="0" allowfullscreen></iframe></div>';
				endif;
