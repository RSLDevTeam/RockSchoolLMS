...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
	...
	<?php if ( ! function_exists('get_cognito_forgot_password_url') ) : ?>
	...
	<?php else : ?>
		...
		<a href="<?php echo esc_url( get_cognito_forgot_password_url() ); ?>" class="reset-password-link" style="margin-bottom: 1em;display: block;">
		    <?php _e('Reset your password ', 'rslfranchise'); ?> <i class="fa fa-external-link" aria-hidden="true"></i>
		</a>
